...
public class DynamicWebTableWithPagination_FilterWebtable_SDET {
	...
	public static void main(String[] args) {
		...
		for (int p = 1; p <= 10; p++) {
			...
			int row = driver.findElements(By.xpath("//table[@class='table table-bordered table-hover']//tbody//tr"))
					.size();
			...
			for (int i = 1; i <= row; i++) {
				...
				String status = driver
						.findElement(By.xpath(
								"//table[@class='table table-bordered table-hover']//tbody//tr[" + i + "]//td[4]"))
						.getText();
