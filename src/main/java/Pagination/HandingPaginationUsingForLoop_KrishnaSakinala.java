...
public class HandingPaginationUsingForLoop_KrishnaSakinala {
	...
	/*
	 * Manual Test Case 1. Open the crome Browser 2.Naviaget to
	 * https://datatables.net/ URL 3.Capture the all names in Webtables 4.Print all
	 * the names 5.Comapare the count showing on the WebTable with the captured
	 * names count.
	 */
