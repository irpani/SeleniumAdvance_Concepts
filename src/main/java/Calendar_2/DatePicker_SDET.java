...
public class DatePicker_SDET {
	...
	public static void main(String[] args) {
		...
		// WebElement checkout =
		// driver.findElement(By.xpath("//input[@id='checkout']"));
		// checkout.click();
		//
	...
	public static void selectCheckinDate(WebDriver driver, String mon_year, String day, int order) {
		while (true) {
			String text = driver
					.findElement(By.xpath("(//div[@class='datepicker-days']//th[@class='switch'])[" + order + "]"))
					.getText();
			...
			if (text.contains(mon_year)) {
				...
				driver.findElement(By.xpath("(//div[@class='datepicker-days']//th[@class='next'])[" + order + "]"))
						.click();
			}
		}
		// driver.findElement(By.xpath("(//div[@class=\"datepicker-days\"])["+order+"]//tbody//tr//td[@class='day
		// ' and contains(text(),'"+day+"')]")).click();
		driver.findElement(By.xpath("(//div[@class='datepicker-days'])[" + order
				+ "]//tbody//tr//td[contains(@class,'day') and contains(text(),'" + day + "')]")).click();
	}
