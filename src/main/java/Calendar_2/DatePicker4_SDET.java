...
public class DatePicker4_SDET {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		DatePicker4_SDET.HandlingDropdown(driver,
				driver.findElement(By.xpath("//select[@class='ui-datepicker-month']")), "Oct");
		Thread.sleep(2000);
		DatePicker4_SDET.HandlingDropdown(driver, driver.findElement(By.xpath("//select[@class='ui-datepicker-year']")),
				"1990");
	...
	public static void selectDate(WebDriver driver, String date) {
		List<WebElement> allDates = driver
				.findElements(By.xpath("//table[@class='ui-datepicker-calendar']//td[contains(@data-event,'click')]"));
